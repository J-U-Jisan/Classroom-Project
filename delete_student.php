<?php
	...
	if(isset($_POST['submit'])){
		...
		$response = Requests::post('http://127.0.0.1/apipro/students/delete.php', array(), $data);
...
<body style="background-color: #858ea1;">
	...
	<div id="Frame0">
		<form action="" method="post">
			<label>Roll No<font style="color:red;">*</font></label>
			<input type="text" name="studentid" id="studentid" placeholder="Enter Roll No..."required>
