<?php 
	...
	if(isset($_POST['submit'])){
		...
		$data = array('courseno' => $courseno, 'studentid' => $studentid, 'admin_id' => $admin_id);		
...
<body style="background-color: #858ea1;">
	...
	<div id="Frame0">
		<h2 style="text-align: center;">Cancel Course From Student</h2>
	</div>
	<div id="Frame0">
			...
			<?php
				...
				foreach ($data as $key =>$value){
					if($value['admin_id']== $_SESSION['userid']){
						$temp = $value['courseno']. '->' .$value['studentid'];
						?>
