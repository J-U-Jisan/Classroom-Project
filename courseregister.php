<?php 
	...
	if(isset($_POST['submit'])){
		...
		$data = array('courseno' => $courseno, 'coursetitle' => $coursetitle, 'admin_id' => $admin_id);		
		
		$response = Requests::post('http://127.0.0.1/apipro/courses/create.php', array(), $data);
...
<body style="background-color: #858ea1;">
	...
	<div style="min-height: 415px;">
		<div id="Frame0">
			<h2 style="text-align: center;">Course Creation</h2>
		</div>
		<div id="Frame0">
		<form action="" method="post">
			...
			<label>Course Title<font style="color:red;">*</font></label>
			<input type="text" name="coursetitle" id="coursetitle" placeholder="Enter Your Course title..." required>
